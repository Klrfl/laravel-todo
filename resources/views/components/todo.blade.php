<li class="flex gap-4 items-center" id="wrapper-{{ $todo->id }}" hx-target="#wrapper-{{ $todo->id }}"
    ...
    <button type="button" class="px-4 py-2 hover:bg-slate-800" @click="isEditing = true" x-show="!isEditing">Edit</button>
    ...
    <button hx-delete="/todo/{{ $todo->id }}" class="bg-red-800 px-4 py-2">
        Delete
    </button>
</li>
